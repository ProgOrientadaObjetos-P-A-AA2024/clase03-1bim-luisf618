...
public class Ejecutable02 {
    ...
    public static void main(String[] args) {
        ...
        /*
        Esta imprimiendo el nombre asignado al atributo nombre del objeto h1,
        tambien imprime los valores por defecto del resto de atributos al no
        recibir ningun valor
        */
